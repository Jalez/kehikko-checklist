 ...
 *
 *   bun run register            # or: PORT=7860 bun run register
 *
 ...
 * the id from the filename, so `roadmap.checklist.json` is what makes this
 * `roadmap.checklist`. Two files naming the same port under different names are
